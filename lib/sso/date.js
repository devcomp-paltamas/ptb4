...
org_apache_myfaces_DateFormatSymbols = function(aLanguage)
{

	this.weekdays = weekDays[aLanguage];
	this.shortWeekdays = shortWeekDays[aLanguage];
	this.shortMonths = shortMonths[aLanguage];
	this.months = months[aLanguage];
	this.eras = eras[aLanguage];
	this.ampms = ampms[aLanguage];
